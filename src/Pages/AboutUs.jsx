    ...
    <>
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          oferecer uma experiência única a quem valoriza sabor e qualidade. Tudo
          começou em uma pequena cozinha, testando torra por torra, até
          encontrarmos o equilíbrio perfeito entre aroma, corpo e doçura. Hoje,
          trabalhamos com produtores que compartilham dos mesmos valores e
          entregamos cafés frescos direto na sua casa.
        </p>
      </div>
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          detalhe, da fazenda até a sua xícara, para garantir que cada gole seja
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          frequência que preferir. Sem complicações, com muito sabor e qualidade
          em cada entrega.
        </p>
      </div>
